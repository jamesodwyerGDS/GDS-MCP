...
const _buttons: Buttons = {
  ...
  tertiary: {
    color: palette.spotlight,
    backgroundColor: palette.cosmos,
  },
  inverse: {
  ...
  disabled: {
    color: palette.slate,
    backgroundColor: palette.diatomite,
  },
  transaction: {
    color: palette.spotlight,
  ...
  pill: {
    color: palette.cosmos,
    // This is the teal color used for selected pill buttons
...
const _links = {
  primary: { color: palette.neptune },
  inverse: { color: palette.spotlight },
};
...
const base = {
  primary: palette.neptune,
  primaryAlt: dark(palette.neptune),
  secondary: palette.callisto,
  border: palette.moonrock,
  borderLight: palette.diatomite,
  borderMidtone: palette.ammonite,
  borderDark: palette.slate,
  bg: palette.spotlight,
  bgAlt: palette.lunar,
  bgInverse: palette.cosmos,
  overlay: "rgba(0, 0, 0, 0.75)",
  overlayText: "rgba(0, 0, 0, 0.50)",
  footerBg: palette.cosmos,
  headerContextBg: palette.cosmos,
};

const text = {
  primary: palette.cosmos,
  secondary: palette.granite,
  accent1: palette.callisto,
  accent2: palette.callisto,
  inverse: palette.spotlight,
  link: palette.neptune,
  linkHover: dark(palette.neptune),
};

const status = {
  success: palette.earth,
  warning: palette.jupiter,
  danger: palette.mars,
  info: palette.neptune,
  default: palette.slate,
};

const btn = {
  primary: palette.neptune,
  checkout: palette.earth,
  inverse: palette.spotlight,
  link: palette.neptune,
  vip: palette.jupiter,
  collector: palette.cosmos,
  text: palette.spotlight,
  iconPrimary: palette.neptune,
  iconSecondary: palette.slate,
};
...
const ism = {
  ...
  available: palette.neutron,
  selected: palette.earth,
};

const badge = {
  active: palette.earth,
  inactive: palette.cosmos,
  package: palette.package,
};

const colors = {
  resale: palette.resale,
  highlight: palette.neptune,
  base: base,
  text: text,
  status: status,
  icons: icons,
