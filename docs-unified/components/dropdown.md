---
name: Dropdown
description: Unified documentation for Dropdown component
audiences:
  - design
  - vibe
...
|--------|-------|
| **Component** | Dropdown |
| **Color Variants** | primary, text, background, border |
| **Figma Node** | 38818:16711 |
...
- text.label: Granite #646464
- text.placeholder: Cosmos #121212
- text.disabled: Slate #949494
- background.default: Spotlight #FFFFFF
- background.disabled: Diatomite #EBEBEB
- background.optionHover: Lunar #F6F6F6
- background.optionSelected: Neptune #024DDF
- border.default: Slate #949494
- border.hover: Neptune #024DDF
- border.focus: Neptune #024DDF
...
```html
<!-- Dropdown Component - Tailwind CSS -->
<!-- Copy-paste ready for Lovable, Figma Make, v0.dev -->
