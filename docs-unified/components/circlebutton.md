---
name: Circlebutton
description: Unified documentation for Circlebutton component
audiences:
  - design
  - engineer
  - vibe
...
storyUrl: 'http://localhost:6006/?path=/story/components-circle-button--default'
sourceFile: components/CircleButton/index.tsx
---
# Circlebutton
...
| **Color Variants** | primary, secondary, tertiary, ghost, inverse, disabled |
| **Package** | `@gds/components` |
| **Figma Node** | 38801:6858 |
...
> Query mode: `@design circlebutton`
...
- secondary.icon: Neptune #024DDF
- tertiary.default: Spotlight #FFFFFF
- tertiary.border: Cosmos #121212
- tertiary.icon: Cosmos #121212
- ghost.default: transparent
- ghost.icon: Neptune #024DDF
- inverse.default: Spotlight #FFFFFF
- inverse.icon: Cosmos #121212
- disabled.background: Diatomite #EBEBEB
- disabled.icon: Slate #949494
- disabled.border: Slate #949494
...
> Query mode: `@engineer circlebutton`
...
[View in Storybook](http://localhost:6006/?path=/story/components-circle-button--default)

### Source

`components/CircleButton/index.tsx`
...
```tsx
<CircleButton>Content</CircleButton>
```
...
Available variants: `Basic`, `Primary`, `Secondary`, `Tertiary`, `Ghost`, `Disabled`, `Inverse`, `InverseDisabled`, `Large`, `WithCheckmarkIcon`, `WithTrashIcon`, `WithCrossIcon`, `WithBigIcon`, `WithRotatedIcon`, `Link`, `DisabledLink`, `DisabledLinkInverse`
...
```html
<!-- CircleButton Component - Tailwind CSS -->
<!-- Copy-paste ready for Lovable, Figma Make, v0.dev -->
