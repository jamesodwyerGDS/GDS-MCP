...
tokens:
  colours:
    default-border:
      token: color.border.slate
      hex: '#949494'
    default-bg:
      token: color.fill.spotlight
      hex: '#FFFFFF'
    hover-border:
      token: color.action.neptune
      hex: '#024DDF'
    active-fill:
      token: color.fill.cosmos
      hex: '#121212'
    active-hover-base:
      token: color.action.neptune
      hex: '#024DDF'
    active-hover-overlay:
      ...
      hex: '#121212'
    disabled-bg:
      token: color.fill.diatomite
      hex: '#EBEBEB'
    disabled-border:
      token: color.border.moonrock
      hex: '#BFBFBF'
    disabled-text:
      token: color.text.granite
      hex: '#646464'
    error-border:
      token: color.feedback.mars
      hex: '#EB0000'
    label-text:
      token: color.text.cosmos
      hex: '#121212'
    inner-dot:
      token: color.fill.spotlight
      hex: '#FFFFFF'
...
| **Color Variants** | default-border, default-bg, hover-border, active-fill, active-hover-base, active-hover-overlay, disabled-bg, disabled-border, disabled-text, error-border, label-text, inner-dot |
| **Figma Node** | 38852:4826 |
...
> Query mode: `@design radio-button`
...
**Colors:**
- default-border.token: color.border.slate
- default-border.hex: #949494
- default-bg.token: color.fill.spotlight
- default-bg.hex: #FFFFFF
- hover-border.token: color.action.neptune
- hover-border.hex: #024DDF
- active-fill.token: color.fill.cosmos
- active-fill.hex: #121212
- active-hover-base.token: color.action.neptune
- active-hover-base.hex: #024DDF
- active-hover-overlay.token: color.fill.cosmos
- active-hover-overlay.hex: #121212
- disabled-bg.token: color.fill.diatomite
- disabled-bg.hex: #EBEBEB
- disabled-border.token: color.border.moonrock
- disabled-border.hex: #BFBFBF
- disabled-text.token: color.text.granite
- disabled-text.hex: #646464
- error-border.token: color.feedback.mars
- error-border.hex: #EB0000
- label-text.token: color.text.cosmos
- label-text.hex: #121212
- inner-dot.token: color.fill.spotlight
- inner-dot.hex: #FFFFFF

**Spacing:**
- radioSize: [object Object]
- innerDotActive: [object Object]
- innerDotDefault: [object Object]
- gap: [object Object]
...
> Query mode: `@engineer radio-button`
