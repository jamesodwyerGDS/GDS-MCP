---
name: Toolbox
description: Unified documentation for Toolbox component
audiences:
  - design
  - vibe
...
- icon.default: Granite #646464
- icon.active: Neptune #024DDF
...
```html
<!-- Toolbox Component - Tailwind CSS -->
<!-- Copy-paste ready for Lovable, Figma Make, v0.dev -->
