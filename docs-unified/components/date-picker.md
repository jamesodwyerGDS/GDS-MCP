---
name: DatePicker
description: Unified documentation for DatePicker component
audiences:
  - design
...
| **Color Variants** | primary, text, background, border, selection |
| **Figma Node** | 38818:15812 |
...
- border.subtle: Moonrock #BFBFBF
- selection.active: Neptune #024DDF
- selection.range: Neptune Light rgba(2, 77, 223, 0.1)
...
> Query mode: `@engineer date-picker`
