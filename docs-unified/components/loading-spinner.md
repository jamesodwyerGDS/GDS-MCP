...
| **Color Variants** | primary, secondary, inverse, labelPrimary, labelInverse |
| **Figma Node** | 33145:12086 |
...
> Query mode: `@design loading-spinner`

**A component with a looping animation that communicates a process or action is ongoing**

### Design Tokens

**Colors:**
- primary.token: Primary/Neptune
- primary.hex: #024DDF
- secondary.token: Secondary/Granite
- secondary.hex: #646464
- inverse.token: Secondary/Spotlight
- inverse.hex: #FFFFFF
- labelPrimary.token: Secondary/Cosmos
- labelPrimary.hex: #121212
- labelInverse.token: Secondary/Spotlight
- labelInverse.hex: #FFFFFF
...
> Query mode: `@engineer loading-spinner`
...
> Query mode: `@vibe loading-spinner`
