---
name: Toast
description: Unified documentation for Toast component
audiences:
  - design
  - engineer
  - vibe
...
|--------|-------|
| **Component** | Toast |
| **Color Variants** | background, text, icon |
| **Package** | `@gds/components` |
| **Figma Node** | 38852:13559 |
...
- background: Cosmos #121212
- text: Spotlight #FFFFFF
- icon.success: Earth #048851
- icon.close: Spotlight #FFFFFF
