...
| **Color Variants** | primary, text, background, border, track |
| **Figma Node** | 40979:2532 |
...
> Query mode: `@design double-range-input`
...
- background.disabled: Ammonite #EBEBEB
- border.default: Slate #949494
- border.disabled: Moonrock #BFBFBF
- border.error: Error Red #D92D20
- track.inactive: Slate #949494
- track.active: Cosmos #121212
...
> Query mode: `@engineer double-range-input`
...
> Query mode: `@vibe double-range-input`
