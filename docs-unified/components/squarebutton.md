---
name: Squarebutton
description: Unified documentation for Squarebutton component
audiences:
  - design
  - engineer
  - vibe
...
storyUrl: 'http://localhost:6006/?path=/story/components-square-button--default'
sourceFile: components/SquareButton/index.tsx
---
# Squarebutton
...
| **Color Variants** | 0, 1, 2, 3, 4, 5, 6, 7 |
| **Package** | `@gds/components` |
| **Figma Node** | 38852:10066 |
...
> Query mode: `@design squarebutton`
...
**Colors:**
- 0.name: primary-default
- 0.token: Neptune
- 0.hex: #024DDF
- 1.name: primary-hover
- 1.token: Neptune Dark
- 1.hex: #0141B8
- 2.name: primary-pressed
- 2.token: Neptune Darker
- 2.hex: #033399
- 3.name: secondary-default
- 3.token: Spotlight
- 3.hex: #FFFFFF
- 4.name: secondary-border
- 4.token: Neptune
- 4.hex: #024DDF
- 5.name: tertiary-border
- 5.token: Cosmos
- 5.hex: #121212
- 6.name: disabled-background
- 6.token: Diatomite
- 6.hex: #EBEBEB
- 7.name: disabled-icon
- 7.token: Slate
- 7.hex: #949494
...
> Query mode: `@engineer squarebutton`
> Styling: **styled-components** (CSS-in-JS)

### Import

```tsx
import { SquareButton } from '@gds/components';
```

### Storybook

[View in Storybook](http://localhost:6006/?path=/story/components-square-button--default)

### Source

`components/SquareButton/index.tsx`
...
```tsx
<SquareButton>Content</SquareButton>
```
...
Available variants: `Basic`, `Primary`, `Secondary`, `Tertiary`, `Disabled`, `Inverse`, `InverseDisabled`, `Loading`, `Large`, `Ghost`, `WithCheckmarkIcon`, `WithTrashIcon`, `WithCrossIcon`, `WithBigIcon`, `WithRotatedIcon`, `Link`, `DisabledLink`, `DisabledLinkInverse`
...
```html
<!-- SquareButton Component - Tailwind CSS -->
<!-- Copy-paste ready for Lovable, Figma Make, v0.dev -->
