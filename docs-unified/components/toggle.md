---
name: Toggle
description: Unified documentation for Toggle component
audiences:
  - design
  - engineer
  - vibe
...
storyUrl: 'http://localhost:6006/?path=/story/components-toggle--default'
...
|--------|-------|
| **Component** | Toggle |
| **Color Variants** | onDefault, offDefault, hover, disabled, knob |
| **Package** | `@gds/components` |
| **Figma Node** | 38852:4937 |
...
**Colors:**
- onDefault.standard: Neptune #024DDF
- onDefault.resale: Nebula #D0006F
- offDefault.background: Spotlight #FFFFFF
- offDefault.border: Slate #949494
- hover.standard: Neptune #024DDF with border
- hover.resale: Nebula #D0006F with border
- disabled.background: Diatomite #EBEBEB
- disabled.border: Moonrock #BFBFBF
- knob.default: Slate #949494
- knob.on: Spotlight #FFFFFF
- knob.disabled: Moonrock #BFBFBF
...
[View in Storybook](http://localhost:6006/?path=/story/components-toggle--default)
