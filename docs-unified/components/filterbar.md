---
name: Filterbar
description: Unified documentation for Filterbar component
audiences:
  - design
  - vibe
...
|--------|-------|
| **Component** | Filterbar |
| **Color Variants** | background, border, icon |
| **Figma Node** | 38818:18119 |
...
- background.hover: Neptune #024DDF
- background.pressed: Neptune #024DDF
- background.disabled: Spotlight #FFFFFF
- border.default: Cosmos #121212
- border.disabled: Slate #949494
- icon.unselected: Cosmos #121212
- icon.selected: Spotlight #FFFFFF
...
```html
<!-- Filterbar Component - Tailwind CSS -->
<!-- Copy-paste ready for Lovable, Figma Make, v0.dev -->
