---
name: "Side Panel"
description: "An overlay that slides in from the left or right, showing extra details or actions related to an item on the page without leaving the current context."
category: "atoms"
status: "stable"
version: "1.0.0"
updated: "2023-10-02"

tags: ["panel", "drawer", "overlay", "sidepanel", "slide-in"]
keywords: ["side panel", "drawer", "slide out", "overlay panel", "contextual panel"]
...
tokens:
  colours:
    background: { token: "popup.background.subtle", hex: "#FFFFFF" }
    overlay: { token: "color.cosmos", hex: "#121212", opacity: 0.6 }
    border: { token: "color.ammonite", hex: "#D6D6D6" }
    text:
      primary: { token: "color.cosmos", hex: "#121212" }
      secondary: { token: "color.granite", hex: "#646464" }
    button:
      primary: { token: "colour.button-bg-blue", hex: "#024DDF" }
      content: { token: "colour.button-content-white", hex: "#FFFFFF" }
  spacing:
    panelWidth:
      desktop: "420px"
      mobile: "375px"
    padding: { token: "space", value: "20px" }
  typography:
    headerTitle: "font.fiji.semibold.18"
    subtitle: "font.etna.regular.14"
    body: "font.rainier.regular.16"
  elevation:
    desktop: { token: "elevation-level-4", value: "0px 8px 20px 0px rgba(0,0,0,0.35)" }
    mobile: { token: "shadow-level-3", value: "0px 3px 12px 0px rgba(18,18,18,0.18)" }
  breakpoints:
    mobile: "375px"
    desktop: "1440px"
...
tailwind:
  colors:
    ...
    sidepanel-bg: "#FFFFFF"
    sidepanel-border: "#D6D6D6"
    sidepanel-text: "#121212"
    sidepanel-text-secondary: "#646464"
    sidepanel-button: "#024DDF"
  spacing:
    sidepanel-width-desktop: "420px"
    sidepanel-width-mobile: "375px"
    sidepanel-padding: "20px"
  shadows:
    sidepanel-shadow-desktop: "0px 8px 20px 0px rgba(0,0,0,0.35)"
    sidepanel-shadow-mobile: "0px 3px 12px 0px rgba(18,18,18,0.18)"

cssVariables:
  - name: "--sidepanel-width"
    value: "420px"
  - name: "--sidepanel-padding"
    value: "20px"
  - name: "--sidepanel-overlay-color"
    value: "rgba(18, 18, 18, 0.6)"
  - name: "--sidepanel-shadow"
