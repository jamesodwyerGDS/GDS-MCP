---
name: Modal
description: A dialog overlay component that displays content requiring user attention or interaction, with multiple sizes and variants for different contexts.
category: atoms
status: stable
version: 1.0.0
updated: 2025-01-06
...
tailwind:
  colors:
    modal-overlay: "rgba(18, 18, 18, 0.6)"
    modal-bg: "#FFFFFF"
  spacing:
...
cssVariables:
  ...
  - name: "--modal-container-bg"
    value: "#FFFFFF"
  - name: "--modal-shadow"
    value: "0px 2px 8px rgba(18, 18, 18, 0.15)"
