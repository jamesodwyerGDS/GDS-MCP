---
name: Link
description: Link component from the Global Design System
package: '@gds/components'
status: stable
version: 1.0.0
updated: '2026-01-10'
sourceFile: components/Link/index.tsx
stylesFile: null
storiesFile: components/Link/__stories__/index.stories.tsx
storyUrl: 'http://localhost:6006/?path=/story/components-link--basic'
...
Link component from the Global Design System Storybook library.
...
```tsx
import Link from '@gds/components/Link';
// or
import { Link } from '@gds/components';
```
...
`Basic`, `Inverse`, `Disabled`, `AsButton`, `Branded`
...
[View in Storybook](http://localhost:6006/?path=/story/components-link--basic)

## Source Files

| File | Path |
|------|------|
| Component | `components/Link/index.tsx` |

| Stories | `components/Link/__stories__/index.stories.tsx` |
