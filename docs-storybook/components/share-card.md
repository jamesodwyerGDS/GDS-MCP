...
stylesFile: null
storiesFile: components/ShareCard/__stories__/index.stories.tsx
storyUrl: 'http://localhost:6006/?path=/story/components-sharecard--basic'
storyId: components-sharecard--basic
tags: []
keywords:
  - share-card
---
...
ShareCard component from the Global Design System Storybook library.
...
```tsx
import ShareCard from '@gds/components/ShareCard';
// or
...
[View in Storybook](http://localhost:6006/?path=/story/components-sharecard--basic)

## Source Files

| File | Path |
|------|------|
| Component | `components/ShareCard/index.tsx` |

| Stories | `components/ShareCard/__stories__/index.stories.tsx` |
