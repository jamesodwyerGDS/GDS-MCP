---
name: SimpleSeatInfo
description: SimpleSeatInfo component from the Global Design System
package: '@gds/components'
status: stable
version: 1.0.0
updated: '2026-01-10'
sourceFile: components/SimpleSeatInfo/SimpleSeatInfo.tsx
stylesFile: null
storiesFile: components/SimpleSeatInfo/__stories__/SimpleSeatInfo.stories.tsx
storyUrl: 'http://localhost:6006/?path=/story/components-simpleseatinfo--basic'
storyId: components-simpleseatinfo--basic
tags: []
keywords:
  - simple-seat-info
---
...
SimpleSeatInfo component from the Global Design System Storybook library.
...
```tsx
import SimpleSeatInfo from '@gds/components/SimpleSeatInfo';
// or
import { SimpleSeatInfo } from '@gds/components';
```
...
```tsx
<SimpleSeatInfo>Content</SimpleSeatInfo>
```
...
[View in Storybook](http://localhost:6006/?path=/story/components-simpleseatinfo--basic)

## Source Files

| File | Path |
|------|------|
| Component | `components/SimpleSeatInfo/SimpleSeatInfo.tsx` |

| Stories | `components/SimpleSeatInfo/__stories__/SimpleSeatInfo.stories.tsx` |
