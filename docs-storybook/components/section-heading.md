---
name: SectionHeading
description: SectionHeading component from the Global Design System
...
stylesFile: null
storiesFile: components/SectionHeading/__stories__/index.stories.tsx
storyUrl: 'http://localhost:6006/?path=/story/components-sectionheading--basic'
storyId: components-sectionheading--basic
tags: []
keywords:
  - section-heading
---
...
SectionHeading component from the Global Design System Storybook library.
...
```tsx
import SectionHeading from '@gds/components/SectionHeading';
// or
...
|------|------|---------|----------|-------------|
| `isCentered` | `boolean` | `(props: Props) =>` | No | - |
...
[View in Storybook](http://localhost:6006/?path=/story/components-sectionheading--basic)

## Source Files

| File | Path |
|------|------|
| Component | `components/SectionHeading/index.tsx` |

| Stories | `components/SectionHeading/__stories__/index.stories.tsx` |
