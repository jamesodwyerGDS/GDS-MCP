...
stylesFile: null
storiesFile: components/Modal/__stories__/modal.stories.tsx
storyUrl: 'http://localhost:6006/?path=/story/components-modal--basic'
...
Modal component from the Global Design System Storybook library.
...
```tsx
import Modal from '@gds/components/Modal';
// or
...
`Standard`, `Warning`, `Error`, `Loading`, `WithImage`, `NotCloseable`, `Scrollable`, `WithCustomAutoFocus`, `WithNoFooterActions`
...
[View in Storybook](http://localhost:6006/?path=/story/components-modal--basic)

## Source Files

| File | Path |
|------|------|
| Component | `components/Modal/Modal.tsx` |

| Stories | `components/Modal/__stories__/modal.stories.tsx` |
