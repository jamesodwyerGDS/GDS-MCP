---
name: CircleButton
description: CircleButton component from the Global Design System
...
stylesFile: null
storiesFile: components/CircleButton/__stories__/index.stories.tsx
storyUrl: 'http://localhost:6006/?path=/story/components-circlebutton--basic'
storyId: components-circlebutton--basic
tags: []
keywords:
  - circle-button
---
...
CircleButton component from the Global Design System Storybook library.
...
```tsx
import CircleButton from '@gds/components/CircleButton';
// or
...
|------|------|---------|----------|-------------|
| `variant` | `CircleButtonVariant` | `'primary'` | No | - |
| `label` | `React.ReactNode` | `-` | Yes | - |
| `icon` | `React.ReactNode` | `-` | No | - |
| `size` | `CircleButtonSize` | `'normal'` | No | - |
...
`Basic`, `Primary`, `Secondary`, `Tertiary`, `Ghost`, `Disabled`, `Inverse`, `InverseDisabled`, `Large`, `WithCheckmarkIcon`, `WithTrashIcon`, `WithCrossIcon`, `WithBigIcon`, `WithRotatedIcon`, `Link`, `DisabledLink`, `DisabledLinkInverse`
...
[View in Storybook](http://localhost:6006/?path=/story/components-circlebutton--basic)

## Source Files

| File | Path |
|------|------|
| Component | `components/CircleButton/index.tsx` |

| Stories | `components/CircleButton/__stories__/index.stories.tsx` |
