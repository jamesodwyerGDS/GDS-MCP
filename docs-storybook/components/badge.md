---
name: Badge
description: Badge component from the Global Design System
...
stylesFile: null
storiesFile: components/Badge/__stories__/index.stories.tsx
storyUrl: 'http://localhost:6006/?path=/story/components-badge--basic'
...
Badge component from the Global Design System Storybook library.
...
```tsx
import Badge from '@gds/components/Badge';
// or
...
`Basic`, `Sales`, `Label`, `Bordered`, `Filled`, `BorderedWithIcon`, `Required`, `Confirmed`, `NearYou`, `Promoted`, `PromotedInverse`, `RTL`
...
[View in Storybook](http://localhost:6006/?path=/story/components-badge--basic)

## Source Files

| File | Path |
|------|------|
| Component | `components/Badge/index.tsx` |

| Stories | `components/Badge/__stories__/index.stories.tsx` |
