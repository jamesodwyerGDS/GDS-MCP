...
stylesFile: null
storiesFile: components/RadioButton/__stories__/index.stories.tsx
storyUrl: 'http://localhost:6006/?path=/story/components-radiobutton--basic'
storyId: components-radiobutton--basic
tags: []
keywords:
  - radio-button
---
...
RadioButton component from the Global Design System Storybook library.
...
```tsx
import RadioButton from '@gds/components/RadioButton';
// or
...
`Basic`, `RadioGroup`, `WithError`, `RTL`
...
[View in Storybook](http://localhost:6006/?path=/story/components-radiobutton--basic)

## Source Files

| File | Path |
|------|------|
| Component | `components/RadioButton/index.tsx` |

| Stories | `components/RadioButton/__stories__/index.stories.tsx` |
