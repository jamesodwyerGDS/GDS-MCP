---
name: SuccessMessage
description: SuccessMessage component from the Global Design System
...
stylesFile: null
storiesFile: components/SuccessMessage/__stories__/index.stories.tsx
storyUrl: 'http://localhost:6006/?path=/story/components-successmessage--basic'
storyId: components-successmessage--basic
tags: []
keywords:
  - success-message
---
...
SuccessMessage component from the Global Design System Storybook library.
...
```tsx
import SuccessMessage from '@gds/components/SuccessMessage';
// or
...
[View in Storybook](http://localhost:6006/?path=/story/components-successmessage--basic)

## Source Files

| File | Path |
|------|------|
| Component | `components/SuccessMessage/index.tsx` |

| Stories | `components/SuccessMessage/__stories__/index.stories.tsx` |
