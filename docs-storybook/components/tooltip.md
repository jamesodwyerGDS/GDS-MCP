...
stylesFile: null
storiesFile: components/Tooltip/__stories__/index.stories.tsx
storyUrl: 'http://localhost:6006/?path=/story/components-tooltip--basic'
...
Tooltip component from the Global Design System Storybook library.
...
```tsx
import Tooltip from '@gds/components/Tooltip';
// or
...
`Basic`, `StartBottom`, `CentreBottom`, `EndBottom`, `StartTop`, `CentreTop`, `EndTop`, `WithComponentMessage`, `AllPositions`, `ScrollablePosition`, `Custom`, `CustomWithOffset`
...
[View in Storybook](http://localhost:6006/?path=/story/components-tooltip--basic)

## Source Files

| File | Path |
|------|------|
| Component | `components/Tooltip/index.tsx` |

| Stories | `components/Tooltip/__stories__/index.stories.tsx` |
