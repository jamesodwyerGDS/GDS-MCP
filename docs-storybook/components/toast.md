...
stylesFile: null
storiesFile: components/Toast/__stories__/index.stories.tsx
storyUrl: 'http://localhost:6006/?path=/story/components-toast--basic'
storyId: components-toast--basic
tags: []
keywords:
  - toast
---
...
Toast component from the Global Design System Storybook library.
...
```tsx
import Toast from '@gds/components/Toast';
// or
...
|------|------|---------|----------|-------------|
| `message` | `string` | `-` | Yes | - |
| `variant` | `Variant` | `'inverse'` | No | - |
| `role` | `AriaRole` | `{role` | Yes | - |
| `dismissable` | `{ onDismiss: () => void` | `-` | Yes | - |
...
`Basic`, `Info`, `Success`, `Warning`, `Error`, `Log`, `ShortMessage`
...
[View in Storybook](http://localhost:6006/?path=/story/components-toast--basic)
...
| Stories | `components/Toast/__stories__/index.stories.tsx` |
