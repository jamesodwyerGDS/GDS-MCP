...
stylesFile: null
storiesFile: components/Checkbox/__stories__/index.stories.tsx
storyUrl: 'http://localhost:6006/?path=/story/components-checkbox--basic'
...
Checkbox component from the Global Design System Storybook library.
...
```tsx
import Checkbox from '@gds/components/Checkbox';
// or
...
`Basic`, `Disabled`, `WithErrorMessage`, `ErrorWithoutMessage`, `Indeterminate`, `RTL`
...
[View in Storybook](http://localhost:6006/?path=/story/components-checkbox--basic)

## Source Files

| File | Path |
|------|------|
| Component | `components/Checkbox/index.tsx` |

| Stories | `components/Checkbox/__stories__/index.stories.tsx` |
